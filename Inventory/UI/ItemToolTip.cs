...
public class ItemTooltip : MonoBehaviour
{
    ...
    public void SetupResourcePanel(int ID)
    {
        ...
        for(int i = 0; i < resourceItem.Length; i++) // I set three components UI in advance
        {
            if(i < bluePrintDetails.resourceItem.Length) // but I want to close possible UI if the UI is not responsible to display anything
            {
